...
import com.cleanroom.orangecore.api.food.ItemFoodProxy;
...
public class Hooks
{
	...
	{
		com.cleanroom.orangecore.api.food.IEdible edibleBlock = (com.cleanroom.orangecore.api.food.IEdible)block;
