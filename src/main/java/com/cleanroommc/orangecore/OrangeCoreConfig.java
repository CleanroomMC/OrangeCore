...
@Config(modid = OrangeCoreMod.MOD_ID)
public class OrangeCoreConfig {
    ...
    @Config.LangKey("config." + OrangeCoreMod.MOD_ID + ".general.food.decayModifier")
    ...
    @Config.LangKey("config." + OrangeCoreMod.MOD_ID + ".general.food.decayStackTime")
